    ...
    <div>
      ...
      <MealContainer>
        {props.mealplan.length === 0 ? (
          ...
          props.mealplan.tuesday.meals.map((item) => (
      ...
      {props.mealplan.length === 0 ? (
        ...
        <Div>
          ...
          <p>Calories - {props.mealplan.tuesday.nutrients.calories}</p>
          <p>Protien - {props.mealplan.tuesday.nutrients.protein}</p>
          <p>Fat - {props.mealplan.tuesday.nutrients.fat}</p>
          <p>
            Carbohydrates - {props.mealplan.tuesday.nutrients.carbohydrates}
          </p>
        </Div>
      )}
    </div>
