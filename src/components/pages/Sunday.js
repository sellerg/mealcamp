    ...
    <div>
      ...
      <MealContainer>
        {props.mealplan.length === 0 ? (
          ...
          props.mealplan.sunday.meals.map((item) => (
      ...
      {props.mealplan.length === 0 ? (
        ...
        <Div>
          ...
          <p>Calories - {props.mealplan.sunday.nutrients.calories}</p>
          <p>Protien - {props.mealplan.sunday.nutrients.protein}</p>
          <p>Fat - {props.mealplan.sunday.nutrients.fat}</p>
          <p>Carbohydrates - {props.mealplan.sunday.nutrients.carbohydrates}</p>
        </Div>
      )}
    </div>
  );
