    ...
    <div>
      ...
      <MealContainer>
        {props.mealplan.length === 0 ? (
          ...
          props.mealplan.friday.meals.map((item) => (
      ...
      {props.mealplan.length === 0 ? (
        ...
        <Div>
          ...
          <p>Calories - {props.mealplan.friday.nutrients.calories}</p>
          <p>Protien - {props.mealplan.friday.nutrients.protein}</p>
          <p>Fat - {props.mealplan.friday.nutrients.fat}</p>
          <p>Carbohydrates - {props.mealplan.friday.nutrients.carbohydrates}</p>
        </Div>
      )}
    </div>
  );
